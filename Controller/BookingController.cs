...
namespace bookingtaxi_backend.Controller
{
    ...
    public class BookingController : ControllerBase
    {
        ...
        [Authorize]
        [HttpGet("GetDriverInProgressBooking")]
        public async Task<Booking?> GetDriverInProgressBooking(String driverID)
        {
            var a = await _bookingService.GetDriverInProgressBooking(driverID);
            return a;
        }
        ...
        [Authorize]
        [HttpGet("GetAllCompletedBookingsByCustomer")]
        public async Task<List<Booking>> GetAllCompletedBookingsByCustomer(string customerID)
        {
            return await _bookingService.GetAllCompletedBookingsByCustomer(customerID);
        }
        ...
        [Authorize]
        [HttpGet("IsDriverAvailableForBooking")]
        public async Task<bool> IsDriverAvailableForBooking(string driverID)
        {
            return await _bookingService.IsDriverAvailableForBooking(driverID);
        }
        ...
        public async Task<IActionResult> DriverCancelBooking(string driverID, string bookingID)
        {
            await _bookingService.DriverCancelBooking(driverID, bookingID);
            return Ok();
        }
